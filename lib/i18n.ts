...
export const copy = {
  id: {
    ...
    about: { index: "03 / PROFIL", title: "Tentang Saya", detail: "Perjalanan, prinsip, dan cara saya membangun produk digital.", approach: "Pendekatan", heading: "Bangun dari konteks, bukan dari template.", body: "Saya mengembangkan aplikasi web dan mobile dari antarmuka hingga backend, dengan fokus pada fungsi, responsivitas, dan pengalaman yang nyaman digunakan.", clarity: "Jelas sebelum ramai", clarityText: "Struktur dan hierarki harus bekerja sebelum motion ditambahkan.", detailTitle: "Detail yang terasa", detailText: "Rasa visual tumbuh dari keputusan kecil yang konsisten.", tech: "Teknologi sebagai alat", techText: "Tools dipilih untuk melayani ide dan pengalaman." },
  ...
  en: {
    ...
    about: { index: "03 / PROFILE", title: "About Me", detail: "My journey, principles, and approach to building digital products.", approach: "Approach", heading: "Build from context, not from templates.", body: "I develop web and mobile applications from interface to backend, focusing on function, responsiveness, and an effortless user experience.", clarity: "Clarity before noise", clarityText: "Structure and hierarchy must work before motion is introduced.", detailTitle: "Details you can feel", detailText: "Visual character grows from small, consistent decisions.", tech: "Technology as a tool", techText: "Tools are selected to serve the idea and the experience." },
