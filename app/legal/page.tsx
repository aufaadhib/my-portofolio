...
export default async function LegalPage() {
  ...
  return <><main className="page-shell interior-page legal-page"><div className="text-reveal"><p className="eyebrow" data-page-intro>{t.index}</p></div><div className="text-reveal"><h1 data-page-intro>{t.title}</h1></div><div className="text-reveal"><p className="detail-lead" data-page-intro>{t.lead}</p></div><div className="prose"><h2>{t.heading}</h2><p>{t.body}</p></div></main><SiteFooter locale={locale} /></>;
}
