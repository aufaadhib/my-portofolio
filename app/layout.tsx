...
export const metadata: Metadata = {
  ...
  title: {
    default: "Farhan Aufa Adhib — Full-Stack Developer",
    template: "%s · Farhan Aufa Adhib",
  },
  description: "Full-Stack Web & Mobile Developer.",
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    title: "Farhan Aufa Adhib — Full-Stack Developer",
    description: "Full-Stack Web & Mobile Developer.",
  },
};
...
export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    ...
    >
      ...
      <body>
        <PublicExperience locale={locale}>{children}</PublicExperience>
      </body>
    </html>
  );
}
