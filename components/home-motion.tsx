      ...
      media.add(
        ...
        (context) => {
          ...
          const revealImmediately = () =>
            gsap.set(
              scope.querySelectorAll(
                "[data-home-intro], [data-home-reveal], [data-home-card], [data-home-service], [data-home-footer]",
              ),
            ...
            if (services.length)
              gsap.fromTo(
                ...
                { x: desktop ? 46 : 0, y: desktop ? 0 : 30, autoAlpha: 0 },
                {
                  ...
                  ease: "power3.out",
                  clearProps: "transform,opacity,visibility",
                  scrollTrigger: { trigger: services[0], start: "top 86%", once: true },
                },
              );
          });
          ...
          if (certificateCards.length)
            gsap.fromTo(
              ...
              { x: desktop ? 72 : 34, autoAlpha: 0 },
              {
                ...
                clearProps: "transform,opacity,visibility",
                scrollTrigger: {
                  trigger: "[data-home-certificates]",
          ...
          if (footerItems.length)
            gsap.fromTo(
              ...
              { y: 42, autoAlpha: 0 },
              {
                ...
                ease: "power3.out",
                clearProps: "transform,opacity,visibility",
                scrollTrigger: { trigger: footerItems[0], start: "top 88%", once: true },
              },
            );
          ...
          if (desktop) {
            ...
            scope.querySelectorAll<HTMLElement>("[data-home-image-media]").forEach((image) =>
              gsap.fromTo(
                image,
                { scale: 1.08 },
                {
