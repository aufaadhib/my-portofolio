...
-- CreateEnum
CREATE TYPE "DocumentKind" AS ENUM ('PROFILE', 'PROJECT', 'SERVICE', 'SETTINGS');
...
-- CreateIndex
CREATE UNIQUE INDEX "ContentDocument_kind_slug_key" ON "ContentDocument"("kind", "slug");

-- CreateIndex
CREATE INDEX "ContentRevision_documentId_status_idx" ON "ContentRevision"("documentId", "status");
